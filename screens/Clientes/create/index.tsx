    ...
    <ScrollView>
      <Box my="$6" mx="$10" gap="$5">
        ...
        >
          ...
          <Input>
            <InputField type="text" placeholder="Nome do Cliente" />
          </Input>
          ...
          <FormControlError>
            ...
            <FormControlErrorText>O nome é obrigatório.</FormControlErrorText>
          </FormControlError>
        </FormControl>
        <FormControl
          isInvalid={false}
        ...
        >
          ...
          <Input>
            <InputField type="text" placeholder="Sobrenome do cliente" />
          </Input>
