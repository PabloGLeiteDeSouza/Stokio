          ...
          onSubmit={async (values) => {
            try {
              if (values.tipo_empresa === 'pf') {
                const data_emp: UpdateEmpresaDto = {
                  id: values.id,
                ...
                const data_end: UpdateEnderecoDto = {
                ...
                await new Endereco(db).update(Number(data_end.id), data_end);
                await new Empresa(db).update(Number(data_emp.id), data_emp);
                ...
                Alert.alert('Sucesso!', MessagesSuccess.update.empresas);
                navigation?.navigate('listar-empresas');
              }
            } catch (error) {
              Alert.alert('erro', (error as Error).message);
