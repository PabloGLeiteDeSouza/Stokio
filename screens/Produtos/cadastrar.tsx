...
type CadastrarProdutosScreenProps = {
  ...
  >;
  route: RouteProp<ParamListBaseRouteCadastrarProdutos, 'cadastro_de_produtos'>;
};
export default function CadastrarProdutosScreen({
  ...
  if (route.params && route.params.barcode && route.params.barcode != Barcode) {
        ...
        <Box flexDirection="column" gap="$2.5">
          ...
          >
            ...
            <Input>
              <InputField
                ...
                onChangeText={(text) => setBarcode(text.replace(/\D/gim, ''))}
              ...
              >
                <ButtonIcon as={() => <FontAwesome name="barcode" />} />
              </Button>
            </Input>
          ...
          >
            ...
            <Input>
              ...
              >
                <ButtonIcon
                  as={() => <FontAwesome name="plus" color={'white'} />}
                />
              </Button>
              <InputField
                type="text"
                ...
                onChangeText={(text) =>
                  setQuantidade(Number(text.replace(/\D/gim, '')))
                }
              />
              <Button
                onPress={() => {
              ...
              >
                <ButtonIcon
                  as={() => <FontAwesome name="minus-circle" color={'white'} />}
                />
              </Button>
            </Input>
          ...
          >
            <FormControlLabel>
              <FormControlLabelText>Medida</FormControlLabelText>
            </FormControlLabel>
            <Input>
              <InputField
                type="text"
              ...
              <Select
                ...
                onValueChange={(medida) => setMedida(medida)}
              >
