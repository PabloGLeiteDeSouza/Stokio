...
export default async function start_new_database(db:SQLiteDatabase) {
    ...
    await db.runAsync(`CREATE TABLE cliente ( 
        id INTEGER PRIMARY KEY AUTOINCREMENT, cep TEXT NOT NULL, logradouro TEXT NOT NULL, numero INTEGER NOT NULL, complemento TEXT, bairro TEXT NOT NULL, cidade TEXT NOT NULL, uf VARCHAR(2) NOT NULL, saldo REAL, id_pessoa INTEGER NOT NULL, FOREIGN KEY (id_pessoa) REFERENCES pessoa(id))`)
