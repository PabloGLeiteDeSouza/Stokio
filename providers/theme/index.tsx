...
const ThemeProviderApp: React.FC<ThemeProviderAppProps> = ({ children }) => {
  ...
  Appearance.addChangeListener(async (preferences) => {
    if (Platform.OS === "android") {
      await NavigationBar.setBackgroundColorAsync(preferences.colorScheme === "dark" ? "#262626" : "#F1F1F1")
      await NavigationBar.setButtonStyleAsync(preferences.colorScheme as 'light' | 'dark')
      await NavigationBar.setBorderColorAsync(preferences.colorScheme === "dark" ? "#404040" : "#DBDBDB")
    }
  });
